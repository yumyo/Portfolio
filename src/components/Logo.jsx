...
export const logoMaskArray = [
	{
		"d": "M11.4 71.2S2.9 60.1 1.6 54.8C.4 49.6 2.1 38.1 9 30.3c8.5-9.7 26.1-19.3 44.5-17.6C68.3 14 95.8 24.7 95 46.2c-.3 7.3-17.5 14.2-28.2 14.3-11.3.1-22.3-1.8-38.2.5",
		"strokeWidth": "4"
	},
  {
	...
	{
		"d": "M67.2 103.6c-2.6 4.1-4.3 2.6-4.7 1.3-3.7-10.7-.7-30.3 1.5-41.2 1.3-6.7 5-27.6 5-27.6",
		"strokeWidth": "4"
	},
	{
		"d": "M67 38.5c.8-1 2.7-3.7 3.2-2.9 3.8 5.3-5.4 21.1-8.7 26.8-4.1 7.1-22 24.7-22 24.7",
		"strokeWidth": "4"
	},
	{
		"d": "M67.3 42.7s5 18.6 7.3 25.3c1.3 4 5.1 13.3 4.8 18.1-.1.9-2.8-1.6-2.8-1.6",
		"strokeWidth": "3"
	},
	{
		"d": "M80.4 86.9c-2-.9-4-2.4-4.7-3.7-2.5-4.7-1.9-16-1.3-21.3.8-7.5 5.3-29.1 17.1-42.2 4-4.4 16.8-13.3 21.6-15.3 3.3-1.4 10.4-2.6 13.9-2.8 3-.2 9 .1 11.9 1.1 3.9 1.4 14.5 8.3 14.5 8.3",
		"strokeWidth": "4"
	}
];
      ...
      <defs>
      
          {
            logoMaskArray.map((path, index) => {
              return (
                <mask id={`brush__0${index}`} key={`s-${index}`} fill="none" stroke="#FFF" strokeWidth={path.strokeWidth} strokeMiterlimit={10}>
                  <path key={`path-${index}`}  d={path.d} ref={e => pathArray[index] = e} />
                </mask>)
            })
          }
