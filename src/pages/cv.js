...
import { Lead, Label, PageTitle, LeftSide, LeftContent, Job } from "../components/theme" 
...
const Cv = ({transitionStatus}) => {
  ...
  return (
      <div className="mx-auto w-k7 pl-7 pr-7 mt-k2v anim-cv opacity-0 flex min-h-screen flex-row flex-wrap items-baseline mb-14">
        <h1 className={`${PageTitle} w-full pl-k25 mb-7`}>Curriculum Vitae</h1>
        <div className={LeftSide}>
          <h2 className={Label}>PROFILE</h2>
        </div>
        <div className={LeftContent}>
          <p className={Lead}>Digital Designer and Front-End Developer, passionate about publishing and taking part in innovative projects spanning a wide range of media and devices. Research, design and development from master-plan to small details.</p>
        </div>
        <div className={LeftSide}>
          <h2 className={Label}>Location</h2>
        </div>
        <div className={LeftContent}>
          <p>I love to travel around the world, but I spend most of my time between the UK, Spain and Italy.</p>
        ...
        <div className={`${LeftContent} flex flex-row justify-between`}>
          ...
          <div>
            ...
            <ul className="list-disc pl-4">
              ...
              <li>Composer, Webpack, Node, NPM, Yarn</li>
        ...
        <div className={LeftContent}>
          <p>In recent years I have been working exclusively for Raconteur Media and alan. agency. I have been mainly developing Here you can see a selection of case histories or browse through my works archive.</p>
        </div>
        <div className={LeftSide}>
        ...
        <div className={LeftContent}>
          <ul>
            <li>Behance: <a href="https://behance.net/kairos" alt="">behance.net/kairos</a></li>
            <li>Twitter: <a href="https://twitter.com/kdsign" alt="">twitter.com/kdsign</a></li>
            <li>LinkedIn: <a href="https://linkedin.com/in/nico-pernice" alt="">linkedin.com/in/nico-pernice</a></li>
            <li>GitHub: <a href="https://github.com/yumyo" alt="">github.com/yumyo</a></li>
            <li>StackOverflow: <a href="https://stackoverflow.com/story/nicola-giulia-pernice" alt="">stackoverflow.com/story/nicola-giulia-pernice</a></li> 
          </ul>
        </div>
        <div className={LeftSide}>
        ...
        <div className={LeftContent}>
          ...
          <li className={Job}>
              ...
              <p className="edu__place">Scrum Alliance, Inc. - London, United Kingdom</p>
            </li>
            <li className={Job}>
